  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <h2 className="text-xl font-medium text-muted-foreground">Custom Forms</h2>
        <Link
          href="/admin/forms/new"
          className="px-4 py-2 bg-muted text-muted-foreground rounded-md hover:bg-[#e5e1de] transition-colors flex items-center gap-2 text-sm">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-gray-200 bg-gray-50">
                <tr>
                  <th className="text-left p-3 px-4 text-muted-foreground font-medium">Form Title</th>
                  <th className="text-left p-3 px-4 text-muted-foreground font-medium">Form Status</th>
                  <th className="text-left p-3 px-4 text-muted-foreground font-medium">Results Status</th>
                  <th className="text-left p-3 px-4 text-muted-foreground font-medium">Actions</th>
                </tr>
              </thead>
              <tbody>
                {forms.map((form) => (
                  <tr
                    ...
                    <td className="p-3 px-4">
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <Link
                          href={`/admin/forms/${form._id}/results`}
