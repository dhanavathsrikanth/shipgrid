  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <h2 className="text-xl font-medium text-muted-foreground">Judging System</h2>
        <button
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="border-b border-gray-200 bg-gray-50">
                <tr>
                  <th className="text-left p-2 px-3 text-muted-foreground font-medium">
                    Group Name
                  </th>
                  <th className="text-left p-2 px-2 text-muted-foreground font-medium">
                    Status
                  </th>
                  <th className="text-left p-2 px-2 text-muted-foreground font-medium">
                    Access
                  ...
                  >
                    ...
                    <td className="p-2 px-3">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Link
                          href={`/admin/judging/${group.slug}/tracking`}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs text-gray-700 hover:text-gray-900 bg-white hover:bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-all font-medium"
                          title="Track judges"
                        >
