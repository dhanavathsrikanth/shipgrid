...
export function FormFieldManagement() {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-muted rounded-lg p-6 border border-gray-200">
        ...
        <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-foreground text-white rounded-md hover:opacity-90 transition-colors flex items-center gap-2 text-sm"
            >
            ...
            <form onSubmit={handleAddField} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-md text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground text-sm"
                    required
                  />
                </div>
                <div>
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  disabled={isProcessing}
                  className="px-4 py-2 bg-foreground text-white rounded-md hover:opacity-90 transition-colors disabled:opacity-50 text-sm"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 text-muted-foreground hover:text-muted-foreground rounded-md text-sm"
                >
                  Cancel
                </button>
              </div>
                      ...
                      {!field.isDeleted ? (
                        <>
                          <button
                            ...
                            className="text-muted-foreground hover:text-muted-foreground disabled:opacity-50 p-1"
                            title={
