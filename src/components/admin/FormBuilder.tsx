...
export function FormBuilder({ formId: formIdProp }: { formId?: string }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (savedFormId) {
        ...
        router.replace(`/admin/forms/${savedFormId}`);
      }
      ...
      const fieldsToSave = fields.map((f, index) => {
        ...
        return {
          ...
          fieldType: f.fieldType as "email" | "url" | "shortText" | "longText" | "yesNo" | "dropdown" | "multiSelect",
  ...
  if (formId && isAuthenticated && existingFormData === null) {
    return (
      <div>
        Form not found. <Link href="/admin/forms/new">Create a new one?</Link>
      </div>
    );
  }
    ...
    >
      <div className="flex justify-between items-start gap-2">
        ...
        <input
          ...
          className="flex-1 px-3 py-2 bg-white border border-gray-300 rounded-md text-sm text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground"
        />
        {/* Field Type Selector */}
        <select
          ...
          className="px-2 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground"
        >
          {FIELD_TYPES.map((ft) => (
      ...
      {(field.fieldType === "shortText" ||
        ...
        <input
          ...
          className="w-full px-3 py-1 bg-gray-50 border border-gray-200 rounded-md text-xs text-gray-500 focus:outline-none focus:ring-1 focus:ring-foreground"
        />
      )}
          ...
          {(field.options || []).map((option, index) => (
            <div key={index} className="flex gap-2 items-center">
              <input
                ...
                className="flex-1 px-2 py-1 bg-white border border-gray-300 rounded-md text-sm text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground"
              />
              <button
                onClick={() => {
      ...
      <div className="flex items-center justify-end">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="rounded border-gray-300 text-foreground focus:ring-foreground focus:ring-offset-0 h-4 w-4"
          />
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-white border border-gray-300 text-muted-foreground rounded-md hover:bg-gray-50 transition-colors flex items-center gap-1.5 text-sm"
          >
          ...
          <button
            ...
            className="px-4 py-1.5 bg-foreground text-white rounded-md hover:opacity-90 transition-colors flex items-center gap-2 disabled:opacity-50 text-sm font-medium"
          >
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground text-sm"
                required
              />
            </div>
