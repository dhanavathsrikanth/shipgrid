...
- [x] Modify `src/components/ui/navbar-5.tsx` to restrict Hackathon and Judging links to admins
- [x] Update Desktop navigation logic
- [x] Update Mobile navigation logic
- [x] Verify changes
...
- [x] refactor `convex/users.ts` to use `ConvexError` for better client-side error reporting
- [x] fix "Server Error" in `setUsername` mutation and optimized database lookups
- [x] verify Clerk environment logic and provided guidance for Prod/Preview keys
- [x] restrict judging and hackathon links to admin role in navbar
