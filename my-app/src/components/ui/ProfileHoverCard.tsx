        ...
        >
          ...
          <div className="flex items-start gap-3 mb-3">
            <div className="flex-shrink-0">
              {userData.imageUrl ? (
                ...
                <div className="w-12 h-12 rounded-full bg-foreground flex items-center justify-center border border-border">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {userData.website && (
                <a
                  ...
                  className="flex items-center gap-1 px-2 py-1 bg-muted hover:bg-muted-foreground/10 rounded text-xs text-muted-foreground transition-colors"
                  title="Website"
                >
          ...
          <div className="pt-2 border-t border-border">
            <Link
              ...
              className="block w-full text-center py-2 px-3 bg-foreground text-primary-foreground rounded-md text-sm font-medium hover:opacity-90 transition-colors"
            >
              View Profile
            </Link>
          </div>
