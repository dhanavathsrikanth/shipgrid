  ...
  return (
    <div className="bg-white rounded-lg p-6 border border-gray-200">
      ...
      <div className="space-y-4">
        <h3 className="font-medium text-muted-foreground">Test Email Types</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-2 bg-foreground text-white rounded hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed text-sm transition-colors"
            >
          ...
          {/* Weekly Digest */}
          <div className="border rounded-lg p-4 bg-gray-50">
            <h4 className="font-medium mb-2 text-muted-foreground">Weekly Digest</h4>
            <p className="text-xs text-gray-600 mb-3">
