        ...
        <div className="space-y-4">
                  ...
                  <div className="relative">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2 bg-white border border-border rounded-md text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground"
                        disabled={isSendingBroadcast}
                      />
                    </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full px-3 py-2 bg-white border border-border rounded-md text-muted-foreground focus:outline-none focus:ring-1 focus:ring-foreground font-mono text-sm"
              disabled={isSendingBroadcast}
            />
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-foreground text-white rounded-md hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSendingBroadcast ? (
