...
export function YCHackForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Link
        href="/"
        className="text-muted-foreground hover:text-muted-foreground inline-block mb-6"
      >
        ← Back to Apps
      </Link>
      ...
      <div className="bg-white p-6 rounded-lg border border-border">
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {availableTags
                ...
                .map((tag: Tag) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-sm transition-colors border ${selectedTagIds.includes(tag._id) ? "bg-muted text-foreground border-border" : "bg-white text-muted-foreground border-border hover:border-input hover:text-muted-foreground"}`}
                  >
                    {tag.name}
                  </button>
                ))}
          ...
          <div className="flex gap-4 items-center pt-4 border-t border-muted">
            <button
              type="submit"
              disabled={
                isSubmitting ||
              ...
              className="px-4 py-2 bg-foreground text-white rounded-md hover:opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
