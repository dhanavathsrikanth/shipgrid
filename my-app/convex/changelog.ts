...
/** List public changelog entries for a story, newest first */
...
/** Post a new update — only the story owner is allowed */
...
/** Delete an update — only the story owner is allowed */
